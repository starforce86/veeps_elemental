...
from apps.api.models import Playout
...
class ShowRunner(models.Model):
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name="showrunner")
    playout = models.ForeignKey(Playout, on_delete=models.CASCADE, related_name="showrunners")
